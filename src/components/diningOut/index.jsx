...
import { diningOutExploreList } from '../../data/diningOutRestaurants';

const diningOutRestaurantsCollectionList = [
    {
        id: 1,
...
const DiningOut = () => {
    return (
        <div>
            <TopRestaurantsCollection data={diningOutRestaurantsCollectionList}></TopRestaurantsCollection>
            <div className='max-width'>
                <Filters filters={diningOutFilters}></Filters>
                <Offer></Offer>
                <ExploreSection collectionTitle="Trending dining restaurants in Lucknow" datas={diningOutExploreList} isShowGoldenOffer={true}></ExploreSection>
            </div>
        </div>
    );
};
